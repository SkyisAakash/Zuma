...
toggleTimerStatus(value){
  ...
  draw(ctx) {
    ...
    ctx.fillText(`You lost by ${this.balls.length} balls`,this.canvasEl.width/2,50);
    ctx.fillText(`But hey, you blew ${this.removedBalls} balls`,this.canvasEl.width/2,150);
    // debugger
  }
  }
