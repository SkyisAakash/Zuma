...
class MovingObject {
  constructor(options) {
    ...
    // this.targetball = this.targetball | 0;
  }
  ...
  move(timeDelta) {
    if (this.ballname === "fireball"){
      ...
      // console.log(this.id);
      // console.log(this.game.targetball);
    // }
    // console.log(this.game.targetball);
      ...
      else { this.percent += this.speed; }
      if(this.percent<0){ this.percent=0; this.direction=1; }
      // if(this.percent>191){ this.percent=0; this.direction=-1; }
      let xy;
      if(this.percent<25){
